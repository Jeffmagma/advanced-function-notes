...
\begin{document}
	...
	\begin{itemize}
		...
		\item If the function $f(x)$ has a local minimum/maximum at $(a,\,f(a))$, the reciprocal function $g(x)$ has a local maximum/minumum at $(a,\,\dfrac{1}{f(a)})$
	...
	The vertical line $x=a$ is a vertical asymptote for the graph of the function $f(x)$
