...
\begin{document}
	...
	The inequation $|E(x)|>a\text{, }a\ge0$
	...
	The value of the rational function is unbounded ($\pm\infty$) as $x$ approaches $a$ from the left and right. To find the unbounded value ($\pm\infty$) of the rational function, substitute $a\pm\epsilon$ for $x$
